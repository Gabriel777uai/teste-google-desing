...
// Estilos de rolagem feitos manual, acima é do mobrise.
...
let AnoCopy = document.getElementById("anoCopy");

function atualizaData() {
  let year = new Date();

  let yearAtual = year.getFullYear();

  AnoCopy.textContent = yearAtual;
}
